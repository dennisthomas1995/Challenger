...
//						score=	score+mark;
	...
	private	class parserThread extends Thread {
		...
		public void run() {
			...
			try {
				if(NetworkInformation.isNetworkAvailable(Question.this)){
					...
					if(Response != null && Response.length()>0){
						...
						scorecount = new JSONArray(Response).length();
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case parserThread.SUCCESS:
				...
				{
					Toast.makeText(Question.this, "No records found!" , Toast.LENGTH_SHORT).show();
					Intent intent=new Intent(Question.this, LevelV2.class);
					...
					if (tabletSize) {
						...
						{
							button1.setTextSize(25);
							button1.setTextColor(getResources().getColor(R.color.com_facebook_usersettingsfragment_connected_shadow_color));
							button2.setTextSize(25);
							button2.setTextColor(getResources().getColor(R.color.com_facebook_usersettingsfragment_connected_shadow_color));
							button3.setTextSize(25);
							button3.setTextColor(getResources().getColor(R.color.com_facebook_usersettingsfragment_connected_shadow_color));
							button4.setTextSize(25);
							button4.setTextColor(getResources().getColor(R.color.com_facebook_usersettingsfragment_connected_shadow_color));
							String text = "<html>" +
									"<head>"+
									"<style  type='text/css'>span {	text-align: left;line-height: auto;width: 260px;height:580px auto;float: left;font-size:40px;font-family: Verdana;}</style>"+
									"</head>"+
			...
			case parserThread.NO_DATA:
				...
				Toast.makeText(Question.this, "Sorry! No Data found",Toast.LENGTH_LONG).show();
				break;
			case parserThread.NO_NETWORK:
				Toast.makeText(Question.this, "Network error", Toast.LENGTH_SHORT).show();
				pDialog.dismiss();
				break;
			default:
				//pDialog.dismiss();
	...
	public void DisplayAlert(){
		flaglen=false;
		AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Question.this);
		alertDialogBuilder
		...
		protected String doInBackground(String... s ) {
			...
			try {
				if(NetworkInformation.isNetworkAvailable(Question.this)){
					...
					AppUtils utils=new AppUtils(Question.this);

					uid=utils.getLoginuserid();
					userName=utils.getLoginusername();
					...
					Toast.makeText(Question.this, "No Internet Connectivity",Toast.LENGTH_LONG).show();
					pDialog.dismiss();
				}
		...
		protected void onPostExecute(String Userid) {
			try
			{
				if(parseres1.equals("1")){
					...
					Intent in=new Intent(Question.this,Score.class);
					Bundle bundle=new Bundle();
					bundle.putString("CatId",CatId);
					...
					pDialog.dismiss();
					Toast.makeText(Question.this, "Update failed", Toast.LENGTH_SHORT).show();
				}
